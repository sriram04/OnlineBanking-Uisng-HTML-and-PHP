...
<body style="background-image:url('bgimg2.jpg');background-repeat: no-repeat;background-size:1500px 650px;">
<h1 style="text-align:right"><a href="logout.php">Logout</a></h1>
<h1 style="color:purple; padding:10px; margin:50px; text-align:center; font-family:algerian; font-size:50px; text-indent:0px;">Hi <?php echo $un?>, Welcome to Online Banking</h1>
...
<ul>
  ...
  <img src="th.jpg" class="round" width=200px height=200px></p></li>
